...
[![Version](https://img.shields.io/badge/version-1.6.5-blue.svg)](https://github.com/qisumi/fanqie-qimao-downloader/releases/tag/v1.6.5)
...
- 📖 **在线阅读器** - 内置在线阅读器，支持翻页和滚动模式，书签和阅读设置
