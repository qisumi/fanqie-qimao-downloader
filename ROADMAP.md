...
### v1.7.2 - 最新版本 (2026-02-14)
- ♻️ 完成后端架构收敛：Route -> UseCase -> Repository
- ♻️ 下载任务与 WebSocket 编排统一接入 TaskOrchestrator
- 🛠 导出任务状态持久化（新增 export_tasks 迁移）
- 🛠 补充 ADR，明确 Session 策略与数据访问边界
