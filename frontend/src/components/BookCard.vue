...
.book-card {
  ...
  box-shadow: var(--shadow-card, 0 1px 2px rgba(0, 0, 0, 0.06), 0 4px 12px rgba(0, 0, 0, 0.04));
  cursor: pointer;
...
.book-card:hover {
  box-shadow: var(--shadow-card-hover, 0 4px 16px rgba(0, 0, 0, 0.1), 0 8px 24px rgba(0, 0, 0, 0.05));
